...
\usepackage[style=numeric]{biblatex} %Bibliografia para latex
...
\renewcommand\thefigure{\thesection.\arabic{equation}} %nombre figura
...
\usepackage{titlesec}
  \titleformat{\chapter}[hang] %Formato capitulo tipo hang
    {\bfseries\centering\fontsize{20}{20}\selectfont} %Formato texto
    {\thechapter.} %Etiqueta
